<?php
/* Smarty version 3.1.39, created on 2022-07-19 12:57:19
  from '/home/dosingenierias/proyectos.dosingenierias.com/manager/admin/themes/default/template/user_list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62d6e26f586579_49484069',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '926d2af13b0e3e0e902d4cf94c40aa5c04d9e60e' => 
    array (
      0 => '/home/dosingenierias/proyectos.dosingenierias.com/manager/admin/themes/default/template/user_list.tpl',
      1 => 1656623876,
      2 => 'file',
    ),
  ),
...
function content_62d6e26f586579_49484069 (Smarty_Internal_Template $_smarty_tpl) {
...
';
const str_and_others_tags = '<?php echo l10n('and %s others');?>
';
...
const registered_str = '<?php echo l10n("Registered");?>
';
const last_visit_str = '<?php echo l10n("Last visit");?>
';
const dates_infos = '<?php echo l10n('between %s and %s');?>
'
const hide_str = '<?php echo l10n('Hide');?>
';
const show_str = '<?php echo l10n('Show');?>
';
const user_added_str = '<?php echo l10n('User %s added');?>
';
const str_popin_update_btn = '<?php echo l10n('Update');?>
';
  ...
  <div id="user-table-content">
    <div class="user-manager-header">
      ...
      <div class="UserViewSelector">
        <input type="radio" name="layout" class="switchLayout" id="displayCompact" <?php if ($_COOKIE['pwg_user_manager_view'] == 'compact') {?>checked<?php }?>/><label for="displayCompact"><span class="icon-th-large firstIcon tiptip" title="<?php echo l10n('Compact View');?>
"></span></label><input type="radio" name="layout" class="switchLayout tiptip" id="displayLine" <?php if ($_COOKIE['pwg_user_manager_view'] == 'line' || !$_COOKIE['pwg_user_manager_view']) {?>checked<?php }?>/><label for="displayLine"><span class="icon-th-list tiptip" title="<?php echo l10n('Line View');?>
"></span></label><input type="radio" name="layout" class="switchLayout" id="displayTile" <?php if ($_COOKIE['pwg_user_manager_view'] == 'tile') {?>checked<?php }?>/><label for="displayTile"><span class="icon-pause lastIcon tiptip" title="<?php echo l10n('Tile View');?>
"></span></label>
      </div>
    ...
    <div id='search-user'>
        <div class='search-info'> </div>
                    <input id="user_search2" class='search-input' type='text' placeholder='<?php echo l10n('Search');?>
'> 
    ...
    <div id="advanced-filter-container">
      ...
      <div class="advanced-filters">
        <div class="advanced-filter-status">
          <label class="advanced-filter-label"><?php echo l10n('Status');?>
</label>
        ...
        <div class="advanced-filter-level">
          <label class="advanced-filter-label"><?php echo l10n('Privacy level');?>
</label>
          <div class="advanced-filter-select-container">
        ...
        <div class="advanced-filter-group">
          <label class="advanced-filter-label"><?php echo l10n('Group');?>
</label>
          <div class="advanced-filter-select-container">
        ...
        <div class="advanced-filter-date">
          <div class="advanced-filter-date-title" style="display:flex">
            <span class="advanced-filter-label"><?php echo l10n('Registered');?>
</span>
...
" name="submit"> <span id="applyOnDetails"></span></input>
            ...
            <br />
            <span class="infos icon-ok" style="display:inline-block;display:none;max-width:100%;margin:0;margin-top:30px;min-height:0;border-left: 2px solid #00FF00;"><?php echo l10n('Users modified');?>
</span>
          </p>
        </div>       </fieldset>
    </div>
